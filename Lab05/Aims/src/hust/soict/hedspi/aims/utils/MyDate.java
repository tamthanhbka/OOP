...
public class MyDate {
	...
	public MyDate(String day, String month, String year) {
		...
		String arrDate[] = {"first", "second","third","fourth","fifth","sixth","seventh","eighth","ninth","tenth","eleventh","twelfth","thirteenth","fourteenth","fifteenth","sixteenth","seventeenth","eighteenth","nineteenth","twentieth","twenty-first","twenty-second","twenty-third","twenty-fourth","twenty-fifth","twenty-sixth","twenty-seventh","twenty-eighth","twenty-ninth","thirtieth","thirty-first"};
		for(int i = 0; i<31; i++ ) {
			if(day.equals(arrDate[i])== true) {
				setDay(arrDay[i]);
			}
		}
		setMonth(month);
	...
	public void printDate(String fomat) {
		LocalDate date;
		String arrMonth[] = {"January", "February", "March","April","May","June","July","August","September","October","November","December"};
		String arrDay[] = {"1st","2nd","3rd","4th","5th","6th","7th","8th","9th","10th","11th","12th","13th","14th","15th","16th","17th","18th","19th","20th","21st","22nd","23rd","24th","25th","26th","27th","28th","29th","30th","31st"};
		int ngay=0, thang=0;
		for(int i =0; i< 31;i++) {
			if(this.getDay().equals(arrDay[i])) {
				ngay = i + 1;
			}
		}
		for(int i =0; i< 12; i++) {
			if(this.getMonth().equals(arrMonth[i])) {
				thang = i + 1;
			}
		}
		date = LocalDate.of(year, thang, ngay);
		System.out.println(date.format(DateTimeFormatter.ofPattern(fomat)));
	}
